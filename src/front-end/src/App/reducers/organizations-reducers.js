    ...
    switch (action.type) {
        ...
        case organizationsActionConstants.ORGANIZATIONS_LOADING_SUCCESS:
            return {...state, pending: false,
                payload:
                    {data: {loadedOrganizations: action.organizations}},
                error: null
            };
        case organizationsActionConstants.SELECT_ORGANIZATION:
            return {...state, pending: false,
                payload:
                    {data: {selectedOrganizationOption: action.selectedOrganizationOption}},
                error: null
            };
        default:
            return state;
...
export const organizationPageReducer = (state = {
    ...
    switch (action.type) {
        ...
        case organizationsActionConstants.ORGANIZATION_NOT_FOUND_BY_BIN:
            return {...state, pending: false, organization: null, error: action.error}
        default:
            return state;
    }
};