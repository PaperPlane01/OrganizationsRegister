...
class FinancialAccountsSearchForm extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return <div>
            <Typography variant="headline">Поиск бухгалтерских счетов</Typography>
...
FinancialAccountsSearchForm.propTypes = {
...
const mapStateToProps = (state) => {
    const {validation} = state.financialAccountsSearchPage;
...
export default connect(mapStateToProps, mapDispatchToProps)(FinancialAccountsSearchForm);