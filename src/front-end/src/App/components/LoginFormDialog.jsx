...
class LoginForm extends React.Component {
    ...
    render() {
        ...
        if (this.props.loginError != undefined) {
            if (this.props.loginError === exceptions.NO_MATCH_FOUND_FOR_GIVEN_USERNAME_AND_PASSWORD) {
            ...
            <Dialog open={this.state.opened} onClose={this.handleClickClose}>
                ...
                <DialogContent>
                    ...
                    <TextField id={'passwordInput'}
                           ...
                           type={'password'}/>
                    {errorMessage !== '' ? <div style={{'font-family': 'roboto', 'color': 'red'}}>{errorMessage}</div> : ''}
                </DialogContent>
                <DialogActions>
